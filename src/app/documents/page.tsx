...
const generalInfoDocuments: DocumentItem[] = [
  ...
  { name: "Выписка из реестра лицензий", url: "/doc/Общая-информация/2. Выписка из реестра лицензий.pdf", type: "pdf" },
...
const educationInfoText = `В МБУ ДО СШ «КАШИРА» реализуются дополнительные образовательные программы спортивной подготовки по следующим видам спорта: футбол, спортивная гимнастика, плавание, лыжные гонки, бокс, лёгкая атлетика, шахматы, самбо, киокушин, волейбол.
...
const educationDocuments: DocumentItem[] = [
  ...
  { name: "ООП СП по киокушину", url: "/doc/Образование/4 ООП СП по киокушину.pdf", type: "pdf" },
