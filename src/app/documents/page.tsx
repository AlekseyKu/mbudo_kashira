...
const documents = [
    ...
    { name: "Сводная ведомость результатов проведения специальной оценки условий труда", url: "/doc/Сводная ведомость.pdf" },
    { name: "Перечень рекомендуемых мероприятий по улучшению условий труда", url: "/doc/Перечень мероприятий.pdf" },
