        ...
        <div className="container relative">
          <div className="flex flex-col space-y-12">
            {trainingsData.map((training) => {
              ...
              return (
                <AnimatedDiv key={training.id} transition={{ delay: 0.1 }}>
                  <div className="flex flex-col md:flex-row bg-white dark:bg-slate-900 rounded-xl shadow-md overflow-hidden">
                    {/* Image */}
                    ...
                    <div className="md:w-2/3 w-full p-6 flex flex-col justify-between">
                      <div>
                        <h3 className="text-2xl font-semibold text-primary-blue dark:text-white mb-2">
                          {training.title}
                        </h3>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl p-6 max-w-md w-full relative shadow-lg">
              ...
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-slate-500">
                  Вид спорта: <span className="text-primary-blue font-medium">{selectedCoach.sport}</span>
                </p>
                <p className="text-slate-500">
                  Категория: <span className="text-primary-blue font-medium">{selectedCoach.category}</span>
                </p>
                <p className="text-slate-500">
                  Опыт: <span className="text-primary-blue font-medium">{selectedCoach.experience} лет</span>
                </p>
              </div>
            </div>
          </div>
