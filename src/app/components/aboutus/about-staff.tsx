...
const staff = [
  ...
  { name: "Сурогина Елена Юрьевна", position: "Заместитель директора по спортивной подготовке" },
  { name: "Кузнецова Елена Юрьевна", position: "Заведующая по виду спорта" },
  { name: "Бондарь Татьяна Сергеевна", position: "Заведующая по виду спорта" },
  { name: "Полякова Елена Валерьевна", position: "Специалист по кадрам" },
